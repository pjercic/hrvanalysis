...
def transform_to_rmssd_statistics(rr_list: List[float], timestamp_list: List[str]) -> dict:
    ...
    time_domain_features = get_jamzone_time_domain_features(interpolated_nn_intervals, timestamp_list)
